...
Tary_dataset = dataset_base.copy({
    'name': 'Tary Dataset',
    'train_images': '/home/weng/work/yolact/data/tary/train_info/',
    'train_info': '/home/weng/work/yolact/data/tary/train_info/annotations.json',
    'valid_images': '/home/weng/work/yolact/data/tary/train_info/',
    'valid_info': '/home/weng/work/yolact/data/tary/train_info/annotations.json',
    'has_gt': True,
    'class_names': ('side'),
    'label_map': {1:1}
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': Tary_dataset,
    'num_classes': len(Tary_dataset.class_names) + 1,

    # Image Size
    'max_size': 550,
    
    # Training params
    'lr_steps': (700, 1000, 1200, 1700),
    'max_iter': 2000,
